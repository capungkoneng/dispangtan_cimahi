...
Route::get('preview/{post}', [PostController::class, 'preview'])->name('posts.preview');


// Route::middleware(['auth', 'verified', 'role:super-admin|admin|editor'])->prefix('admin')->group(function () {
